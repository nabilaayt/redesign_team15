...
const Profile = () => {
    return(
        <section id="profile" className="font-poppins">
            ...
            className="flex flex-col py-10 relative lg:flex-row w-full items-center">
                <img 
            ...
            className="flex flex-col lg:flex-row px-6 sm:px-10 md:px-16 py-10 gap-8 lg:gap-16">
            ...
            className="flex flex-col px-6 sm:px-16 md:px-16 py-10 mb-2 gap-3 justify-center items-center">
            ...
            className="flex flex-col px-6 sm:px-16 md:px-16 py-10 gap-3 mb-10 justify-center items-center min-h-screen">
                <h1 className="relative text-gray-950 font-semibold text-center text-2xl mb-8 
                            after:content-[''] after:block after:h-1 after:w-32 after:bg-amber-400 after:mt-2 after:mx-auto">
                    Misi
                </h1>
            ...
            className="flex flex-col lg:flex-row py-1 px-6 sm:px-16 md:px-16 mb-20 gap-10">
